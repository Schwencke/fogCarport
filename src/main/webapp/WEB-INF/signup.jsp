    ...
    <jsp:body>
        <div style="margin-top: 5em;">
            <form name="login" action="${pageContext.request.contextPath}/fc/commandsignup" method="post">
                <div class="row mb-3">
                    <label style="width: 130px" class="col-sm-1 col-form-label" for="name">Navn</label>
                    <div class="col-sm-4">
                        <input id="name" class="form-control" type="text" name="name" value="${param.name}" placeholder="Indtast navn">
                    </div>
                </div>
                <div class="row mb-3">
                    <label style="width: 130px" class="col-sm-1 col-form-label" for="address">Adresse</label>
                    <div class="col-sm-4">
                        <input id="address" class="form-control" type="text" name="address" value="${param.address}" placeholder="Indtast adresse">
                    </div>
                </div>
                <div class="row mb-3">
                    <label style="width: 130px" class="col-sm-1 col-form-label" for="postalcode">Postnummer</label>
                    <div class="col-sm-4">
